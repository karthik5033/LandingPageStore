  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex gap-12 text-[10px] font-bold tracking-[0.2em] uppercase" style={{ color: '#8a7060' }}>
        <a href="#origin" className="hover:text-[#c8922a] transition-colors">Origin</a>
        <a href="#craft" className="hover:text-[#c8922a] transition-colors">Craft</a>
        <a href="#ritual" className="hover:text-[#c8922a] transition-colors">Ritual</a>
        <a href="#products" className="hover:text-[#c8922a] transition-colors">Boutique</a>
      </div>
