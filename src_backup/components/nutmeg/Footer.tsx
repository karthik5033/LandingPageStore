...
export default function Footer() {
  return (
    <footer className="relative z-20 bg-black/40 backdrop-blur-xl py-20 border-t border-[#a1887f]/20">
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-start gap-16 mb-20">
          <div className="max-w-sm">
            <div className="flex items-center gap-3 mb-8">
              <span className="font-light text-2xl tracking-[0.2em] text-white uppercase mt-1" style={{ fontFamily: "'Playfair Display', serif" }}>NUTMEG</span>
            </div>
          ...
          <div className="flex gap-16 md:gap-24">
            <div>
              <h5 className="text-[10px] font-bold tracking-[0.3em] uppercase text-[#a1887f] mb-8">Explore</h5>
            ...
            <div>
              <h5 className="text-[10px] font-bold tracking-[0.3em] uppercase text-[#a1887f] mb-8">Connect</h5>
              <ul className="flex flex-col gap-6 text-sm font-light text-white/60">
                <li><Link href="/gallery" className="hover:text-white transition-colors duration-300">Gallery</Link></li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-10 border-t border-white/5 text-[10px] text-white/40 font-light tracking-[0.2em] uppercase">
          <p>© {new Date().getFullYear()} NUTMEG SPICES. ALL RIGHTS RESERVED.</p>
          <div className="flex gap-8">
            <a href="#" className="hover:text-[#a1887f] transition-colors">Privacy Policy</a>
            <a href="#" className="hover:text-[#a1887f] transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
