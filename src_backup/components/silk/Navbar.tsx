  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex gap-12 text-[10px] font-bold tracking-[0.2em] text-[#e8d5c4] uppercase font-sans">
        <a href="#origin" className="hover:text-[#c8a97e] transition-colors duration-300">Origin</a>
        <a href="#features" className="hover:text-[#c8a97e] transition-colors duration-300">Features</a>
        <a href="#process" className="hover:text-[#c8a97e] transition-colors duration-300">Process</a>
        <a href="#products" className="hover:text-[#c8a97e] transition-colors duration-300">Products</a>
      </div>
