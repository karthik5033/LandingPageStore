...
export default function Template66() {
  ...
  return (
    <div ref={containerRef} className="relative font-sans bg-[#0d1a0d]">
      ...
      <main className="relative z-10 w-full text-white selection:bg-[#88b04b] selection:text-black">
        <section className="h-screen relative flex items-end pb-24 px-8 md:px-16">
          <div className="max-w-7xl w-full mx-auto flex flex-col md:flex-row md:items-end md:justify-between gap-8">
            <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }} className="bg-black/50 backdrop-blur-md border border-white/10 p-8 md:p-12 rounded-xl">
              ...
              <h1 className="leading-[0.9] font-bold text-white" style={{ fontFamily: "'Syne', sans-serif", fontSize: 'clamp(5rem, 14vw, 12rem)' }}>Origin</h1>
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-8 md:px-16 w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
              <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-10%' }} transition={{ duration: 1.2 }} className="bg-black/50 backdrop-blur-md border border-white/10 p-8 md:p-12 rounded-xl">
                ...
                <h2 className="text-5xl md:text-7xl font-bold text-white leading-[1.1] mb-12" style={{ fontFamily: "'Syne', sans-serif" }}>Radical <span className="italic text-[#88b04b]">purity.</span></h2>
                <div className="flex gap-16 pt-10 border-t border-white/[0.06]">
                  <div><span className="text-4xl font-light text-white">0%</span><span className="text-xs uppercase tracking-[0.25em] text-white/30 block mt-2">Additives</span></div>
                  <div><span className="text-4xl font-light text-white">100%</span><span className="text-xs uppercase tracking-[0.25em] text-white/30 block mt-2">Single tree</span></div>
                  <div><span className="text-4xl font-light text-white">Wild</span><span className="text-xs uppercase tracking-[0.25em] text-white/30 block mt-2">Genetics</span></div>
                </div>
              </motion.div>
              <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1.2, delay: 0.2 }} className="flex flex-col justify-center bg-black/50 backdrop-blur-md border border-white/10 p-8 md:p-12 rounded-xl">
                <div className="border-l border-[#88b04b]/20 pl-10">
                  ...
                  <a href="#collection" className="inline-flex items-center gap-4 text-xs font-medium tracking-[0.3em] text-[#88b04b] uppercase hover:text-white transition-colors group"><span>View the yield</span><div className="w-8 h-[1px] bg-[#88b04b] group-hover:w-14 transition-all duration-500" /></a>
                </div>
              </motion.div>
            </div>
          </div>
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1 }} className="grid grid-cols-1 md:grid-cols-3 gap-12">
              {[
                ...
                <motion.div key={t.region} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.15, duration: 0.9 }} className="group bg-black/50 backdrop-blur-md border border-white/10 p-8 md:p-12 rounded-xl">
                  <div className="flex items-baseline gap-3 mb-2"><h3 className="text-2xl font-bold text-white" style={{ fontFamily: "'Syne', sans-serif" }}>{t.region}</h3><span className="text-xs tracking-[0.2em] text-[#88b04b]/50 uppercase">{t.country}</span></div>
        ...
        <section id="reserve" className="min-h-screen flex items-center justify-center px-8 py-40">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1.2 }} className="max-w-3xl text-center">
            ...
            <h2 className="font-bold leading-[1.1] text-white mb-8" style={{ fontFamily: "'Syne', sans-serif", fontSize: 'clamp(3rem, 7vw, 6rem)' }}>Stay <span className="italic text-[#88b04b]">wild.</span></h2>
