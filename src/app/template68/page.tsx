  ...
  return (
    <div ref={containerRef} className="relative bg-black font-sans">
      ...
      <div className="fixed left-12 top-1/2 -translate-y-1/2 -rotate-90 origin-center whitespace-nowrap text-xs tracking-[0.3em] text-white/40 hidden md:block z-40 flex items-center gap-4">
        <span>EST. 2026 — GLACÉ GELATO CO.</span>
      </div>
      ...
      <main className="relative z-10 w-full text-white selection:bg-amber-100 selection:text-black">
        ...
        <section id="origin" className="min-h-[120vh] flex items-center pl-6 md:pl-40 pr-6 relative py-24">
          <div className="max-w-xl">
            ...
            >
              <span className="block text-[#fbcfe8] text-xs font-bold tracking-[0.3em] mb-4 uppercase">
                01. / The Source
              </span>
              ...
              <p className="text-gray-300 text-lg leading-relaxed font-light mb-8 border-l border-[#fbcfe8]/20 pl-6">
                Crafted from the richest local dairy and the finest imported 
                vanilla beans. Our gelato is slowly churned to create a 
                texture so dense and velvety, it defies gravity.
              </p>
              <button className="text-xs font-bold uppercase tracking-widest border-b border-white pb-2 hover:text-[#fbcfe8] hover:border-[#fbcfe8] transition-colors">
                Discover Origins
              </button>
            </motion.div>
          </div>
        ...
        <section id="roast" className="min-h-[120vh] flex items-center pl-6 md:pl-40 pr-6 relative py-24">
          <div className="max-w-xl">
            ...
            >
              ...
              <h2 className="text-5xl md:text-6xl font-serif leading-tight mb-8">
                Patience in <br/>
                <span className="text-gray-400">Every Scoop.</span>
              </h2>
              <p className="text-gray-300 text-lg leading-relaxed font-light mb-8 border-l border-[#fbcfe8]/20 pl-6">
              ...
              <div className="flex gap-8 mt-12">
                 <div>
                    <div className="text-3xl font-serif mb-1">-14°C</div>
                    <div className="text-[10px] uppercase tracking-widest text-gray-500">Serving Temp</div>
                 </div>
                 <div>
                    <div className="text-3xl font-serif mb-1">24h</div>
                    <div className="text-[10px] uppercase tracking-widest text-gray-500">Aging Process</div>
                 </div>
              </div>
            </motion.div>
          </div>
        ...
        <section id="ritual" className="h-[100vh] flex items-center justify-center pl-6 md:pl-40 pr-6">
           <div className="max-w-3xl text-center">
              ...
              >
                  <span className="block text-[#fbcfe8] text-xs font-bold tracking-[0.3em] mb-6 uppercase">
                    03. / The Ritual
                  </span>
                  ...
                  <p className="text-xl text-gray-400 max-w-lg mx-auto mb-12 font-light">
                     Join the select few who understand that dessert is more than an afterthought—it is a daily ceremony of joy.
                  </p>
                  <motion.button 
                     whileHover={{ scale: 1.02 }}
                     whileTap={{ scale: 0.98 }}
                     className="px-10 py-5 bg-white text-black font-bold uppercase tracking-[0.2em] text-sm hover:bg-[#fbcfe8] transition-colors"
                  >
