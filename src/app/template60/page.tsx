    ...
    >
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <ScrollSequence
          ...
          padLength={3}
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#0f1115]/80 via-transparent to-[#0f1115]/40 z-10" />
      </div>

      <main className="relative z-10 w-full text-white premium-text-shadow selection:bg-[#00f0ff] selection:text-black">
        ...
        <section className="h-screen relative flex items-end pb-24 px-8 md:px-16">
          <div className="max-w-7xl w-full mx-auto flex flex-col md:flex-row md:items-end md:justify-between gap-8">
            <motion.div
              ...
              <h1
                className="leading-[0.9] font-light text-white premium-text-shadow"
                style={{
          ...
          <div className="max-w-7xl mx-auto px-8 md:px-16 w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
              <motion.div
                ...
                <h2
                  className="text-5xl md:text-7xl font-light text-white premium-text-shadow leading-[1.1] mb-12"
                ...
                <div className="flex gap-16 pt-10 border-t border-white/[0.06]">
                  <div>
                    <span className="text-4xl font-light text-white premium-text-shadow" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>14μ</span>
                    <span className="text-xs uppercase tracking-[0.25em] text-white/30 block mt-2">Particle size</span>
                  </div>
                  <div>
                    <span className="text-4xl font-light text-white premium-text-shadow" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>3</span>
                    <span className="text-xs uppercase tracking-[0.25em] text-white/30 block mt-2">Ingredients</span>
                  </div>
                  <div>
                    <span className="text-4xl font-light text-white premium-text-shadow" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>0</span>
              ...
              >
                <div className="border-l border-[#00f0ff]/20 pl-10">
                  ...
                  <a href="#collection" className="inline-flex items-center gap-4 text-xs font-medium tracking-[0.3em] text-[#00f0ff] uppercase hover:text-white premium-text-shadow transition-colors group">
              ...
              {[
                ...
                <motion.div
                  ...
                  <div className="flex items-baseline gap-3 mb-2">
                    <h3 className="text-2xl font-light text-white premium-text-shadow" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                      {t.region}
                    </h3>
        ...
        <section id="reserve" className="min-h-screen flex items-center justify-center px-8 py-40">
          ...
          >
            ...
            <h2
              className="font-light leading-[1.1] text-white premium-text-shadow mb-8"
              style={{
                fontFamily: "'Space Grotesk', sans-serif",
