      ...
      <main className="relative z-10 w-full text-white selection:bg-yellow-400 selection:text-black">
        ...
        <section id="hero" className="h-screen relative flex items-center justify-center text-center px-6">
          ...
          <motion.div
            ...
            className="absolute bottom-20 left-1/2 -translate-x-1/2 text-[9px] font-bold tracking-[0.4em] uppercase flex flex-col items-center gap-6 text-yellow-500/80"
          >
            Awaken
            <motion.div
              className="w-[1px] h-16 bg-white/10 relative overflow-hidden"
            >
                <motion.div 
