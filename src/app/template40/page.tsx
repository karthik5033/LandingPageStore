...
import MasalaNavbar from '@/components/masala/Navbar';
import MasalaFeatures from '@/components/masala/Features';
import MasalaProducts from '@/components/masala/Products';
import MasalaProcess from '@/components/masala/Process';
import MasalaFooter from '@/components/masala/Footer';
  ...
  return (
    <div ref={containerRef} className="relative font-sans bg-black overflow-x-hidden">
      ...
      <motion.div
        ...
        style={{ scaleY, background: '#e2725b' }}
      />

      {/* FULLSCREEN CANVAS */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        <ScrollSequence
          folderPath="/spice11-frames"
          frameCount={156}
      ...
      <main className="relative z-10 w-full text-white selection:bg-[#e2725b] selection:text-black">
        ...
        <section id="hero" className="h-screen relative flex items-center justify-center text-center px-6">
          <div className="max-w-5xl relative z-20 mt-16">
            <motion.span
              ...
              className="block text-[10px] font-bold tracking-[0.5em] uppercase mb-10 text-[#e2725b]"
            >
              The Spice Series
            </motion.span>
        ...
        <section id="origin" className="min-h-[120vh] relative z-20 flex items-center py-32">
          <div className="container mx-auto px-6 md:px-16">
            <div className="max-w-xl">
              ...
              >
                <span className="text-[10px] font-bold tracking-[0.4em] text-[#e2725b] uppercase mb-6 block">
                  00. / The Source
                </span>
                <h2 className="text-5xl md:text-6xl font-light text-white mb-10 leading-tight" style={{ fontFamily: "'Playfair Display', serif" }}>
                  Rooted in <br />
                  <span className="italic text-[#e2725b]">tradition.</span>
                </h2>
                <div className="border-l border-[#e2725b]/30 pl-8">
        ...
        {/* CTA SECTION */}
        <section className="py-32 flex items-center justify-center px-6 border-t border-[#e2725b]/10 bg-black/20 backdrop-blur-md border-t border-[#e2725b]/20">
          <div className="max-w-3xl text-center">
            ...
            >
              <h2 className="font-light leading-tight mb-12 text-white" style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(3rem, 6vw, 5rem)' }}>
                Elevate your <br />
                <span className="italic text-[#e2725b]">kitchen.</span>
              </h2>
              <button className="mt-8 px-12 py-5 bg-[#e2725b] text-black text-[9px] font-bold uppercase tracking-[0.4em] hover:bg-white transition-all duration-500">
                Shop the Collection
              </button>
            </motion.div>
          </div>
