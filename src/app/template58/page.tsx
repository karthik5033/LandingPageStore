  ...
  return (
    <div ref={containerRef} className="relative font-sans bg-[#020617]">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#020617]/80 via-transparent to-[#020617]/40 z-10" />
      </div>

      <main className="relative z-10 w-full text-white premium-text-shadow selection:bg-[#94a3b8] selection:text-black">
        ...
        <section className="h-screen relative flex items-end pb-24 px-8 md:px-16">
          <div className="max-w-7xl w-full mx-auto flex flex-col md:flex-row md:items-end md:justify-between gap-8">
            <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}>
              ...
              <h1 className="leading-[0.9] font-normal text-white premium-text-shadow" style={{ fontFamily: "'Cinzel', serif", fontSize: 'clamp(5rem, 14vw, 13rem)' }}>Valor</h1>
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-8 md:px-16 w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
              <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-10%' }} transition={{ duration: 1.2 }}>
                ...
                <h2 className="text-5xl md:text-7xl font-normal text-white premium-text-shadow leading-[1.1] mb-12" style={{ fontFamily: "'Cinzel', serif" }}>Discipline <br /><span className="italic text-[#94a3b8]">over decoration.</span></h2>
                <div className="flex gap-16 pt-10 border-t border-white/[0.06]">
                  <div><span className="text-4xl font-normal text-white premium-text-shadow" style={{ fontFamily: "'Cinzel', serif" }}>72h</span><span className="text-xs uppercase tracking-[0.25em] text-white/30 block mt-2">Conche time</span></div>
                  <div><span className="text-4xl font-normal text-white premium-text-shadow" style={{ fontFamily: "'Cinzel', serif" }}>3</span><span className="text-xs uppercase tracking-[0.25em] text-white/30 block mt-2">Ingredients</span></div>
                  <div><span className="text-4xl font-normal text-white premium-text-shadow" style={{ fontFamily: "'Cinzel', serif" }}>0</span><span className="text-xs uppercase tracking-[0.25em] text-white/30 block mt-2">Excuses</span></div>
                </div>
              </motion.div>
              <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1.2, delay: 0.2 }} className="flex flex-col justify-center">
                <div className="border-l border-[#94a3b8]/20 pl-10">
                  ...
                  <a href="#collection" className="inline-flex items-center gap-4 text-xs font-medium tracking-[0.3em] text-[#94a3b8] uppercase hover:text-white premium-text-shadow transition-colors group"><span>Inspect the armoury</span><div className="w-8 h-[1px] bg-[#94a3b8] group-hover:w-14 transition-all duration-500" /></a>
                </div>
              </motion.div>
            </div>
          </div>
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1 }} className="grid grid-cols-1 md:grid-cols-3 gap-12">
              {[
                ...
                <motion.div key={t.region} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.15, duration: 0.9 }} className="group">
                  <div className="flex items-baseline gap-3 mb-2"><h3 className="text-2xl font-normal text-white premium-text-shadow" style={{ fontFamily: "'Cinzel', serif" }}>{t.region}</h3><span className="text-xs tracking-[0.2em] text-[#94a3b8]/50 uppercase">{t.country}</span></div>
        ...
        <section id="reserve" className="min-h-screen flex items-center justify-center px-8 py-40">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1.2 }} className="max-w-3xl text-center">
            ...
            <h2 className="font-normal leading-[1.1] text-white premium-text-shadow mb-8" style={{ fontFamily: "'Cinzel', serif", fontSize: 'clamp(3rem, 7vw, 6rem)' }}>Earn the <br /><span className="italic text-[#94a3b8]">standard.</span></h2>
