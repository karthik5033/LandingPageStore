  ...
  return (
    <div ref={containerRef} className="relative font-mono bg-[#0a0a0a]">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-black/70 z-10" />
      </div>
      ...
      <main className="relative z-10 w-full text-white premium-text-shadow selection:bg-white selection:text-black">
        <section className="h-screen relative flex items-end pb-24 px-8 md:px-16">
          <div className="max-w-7xl w-full mx-auto flex flex-col md:flex-row md:items-end md:justify-between gap-8">
            <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}>
              ...
              <h1 className="leading-[0.9] font-normal text-white premium-text-shadow" style={{ fontFamily: "'Syncopate', sans-serif", fontSize: 'clamp(4rem, 12vw, 11rem)' }}>Obelisk</h1>
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-8 md:px-16 w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
              <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-10%' }} transition={{ duration: 1.2 }}>
                ...
                <h2 className="text-5xl md:text-7xl font-normal text-white premium-text-shadow leading-[1.1] mb-12" style={{ fontFamily: "'Syncopate', sans-serif" }}>Structured <span className="italic text-white/30">silence.</span></h2>
                <div className="flex gap-16 pt-10 border-t border-white/[0.06]">
                  <div><span className="text-4xl font-normal text-white premium-text-shadow" style={{ fontFamily: "'Syncopate', sans-serif" }}>900g</span><span className="text-xs uppercase tracking-[0.25em] text-white/30 block mt-2">Force capacity</span></div>
                  <div><span className="text-4xl font-normal text-white premium-text-shadow" style={{ fontFamily: "'Syncopate', sans-serif" }}>34°</span><span className="text-xs uppercase tracking-[0.25em] text-white/30 block mt-2">Crystal threshold</span></div>
                  <div><span className="text-4xl font-normal text-white premium-text-shadow" style={{ fontFamily: "'Syncopate', sans-serif" }}>0</span><span className="text-xs uppercase tracking-[0.25em] text-white/30 block mt-2">Stabilisers</span></div>
                </div>
              </motion.div>
              <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1.2, delay: 0.2 }} className="flex flex-col justify-center">
                <div className="border-l border-white/10 pl-10">
                  ...
                  <a href="#collection" className="inline-flex items-center gap-4 text-xs font-medium tracking-[0.3em] text-white/60 uppercase hover:text-white premium-text-shadow transition-colors group"><span>Enter the archive</span><div className="w-8 h-[1px] bg-white/40 group-hover:w-14 transition-all duration-500" /></a>
                </div>
              </motion.div>
            </div>
          </div>
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1 }} className="grid grid-cols-1 md:grid-cols-3 gap-12">
              {[
                ...
                <motion.div key={t.region} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.15, duration: 0.9 }} className="group">
                  <div className="flex items-baseline gap-3 mb-2"><h3 className="text-2xl font-normal text-white premium-text-shadow" style={{ fontFamily: "'Syncopate', sans-serif" }}>{t.region}</h3><span className="text-xs tracking-[0.2em] text-white/30 uppercase">{t.country}</span></div>
        ...
        <section id="reserve" className="min-h-screen flex items-center justify-center px-8 py-40">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1.2 }} className="max-w-3xl text-center">
            ...
            <h2 className="font-normal leading-[1.1] text-white premium-text-shadow mb-8" style={{ fontFamily: "'Syncopate', sans-serif", fontSize: 'clamp(3rem, 7vw, 6rem)' }}>Enter the <span className="italic text-white/30">monolith.</span></h2>
            ...
            <button className="px-14 py-5 border border-white/30 text-white premium-text-shadow text-xs font-medium uppercase tracking-[0.3em] hover:bg-white hover:text-black transition-all duration-500">Join the waitlist</button>
