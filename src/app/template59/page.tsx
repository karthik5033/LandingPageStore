  ...
  return (
    <div ref={containerRef} className="relative font-sans bg-[#1a0f0a]">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#1a0f0a]/80 via-transparent to-[#1a0f0a]/40 z-10" />
      </div>

      <main className="relative z-10 w-full text-[#f5e6d3] selection:bg-[#d2691e] selection:text-white premium-text-shadow">
