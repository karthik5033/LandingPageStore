...
export default function Footer() {
  return (
    <footer className="relative z-20 bg-black/40 backdrop-blur-xl py-20 border-t border-[#ff4500]/20">
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-start gap-16 mb-20">
          ...
          <div className="flex gap-16 md:gap-24">
            <div>
              <h5 className="text-[10px] font-bold tracking-[0.3em] uppercase text-[#ff4500] mb-8">Explore</h5>
            ...
            <div>
              <h5 className="text-[10px] font-bold tracking-[0.3em] uppercase text-[#ff4500] mb-8">Connect</h5>
              <ul className="flex flex-col gap-6 text-sm font-light text-white/60">
                <li><Link href="/gallery" className="hover:text-white transition-colors duration-300">Gallery</Link></li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-10 border-t border-white/5 text-[10px] text-white/40 font-light tracking-[0.2em] uppercase">
          <p>© {new Date().getFullYear()} FLAME SPICES. ALL RIGHTS RESERVED.</p>
