...
export default function NoirFeatures() {
  return (
    <section className="py-32 pl-6 pr-6 md:pl-40 md:pr-12 relative z-10 border-y border-[#3a2010]/30" style={{ background: 'linear-gradient(to bottom, rgba(10,3,0,0.8), rgba(10,3,0,0.4))', backdropFilter: 'blur(8px)' }}>
