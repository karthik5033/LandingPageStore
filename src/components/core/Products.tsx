      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div>
            ...
            <h2
              className="text-5xl md:text-7xl font-light text-white premium-text-shadow leading-[1.1]"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {collection.map((p, i) => (
            ...
            >
              ...
              <h3
                className="text-3xl md:text-4xl font-light text-white premium-text-shadow mb-2 tracking-wide"
                style={{ fontFamily: "'Space Grotesk', sans-serif" }}
              >
                {p.name}
              </h3>
              ...
              <div className="flex items-center justify-between mt-auto pt-8 border-t border-white/[0.06]">
                <div>
                  <span className="text-2xl font-light text-white premium-text-shadow" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>{p.price}</span>
